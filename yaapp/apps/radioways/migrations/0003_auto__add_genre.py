...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Genre'
        db.create_table('radioways_genre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('radioways_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('rtype', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ...
        db.send_create_signal('radioways', ['Genre'])

        # Adding M2M table for field genres on 'Radio'
        db.create_table('radioways_radio_genres', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('radio', models.ForeignKey(orm['radioways.radio'], null=False)),
            ('genre', models.ForeignKey(orm['radioways.genre'], null=False))
        ))
        db.create_unique('radioways_radio_genres', ['radio_id', 'genre_id'])


    def backwards(self, orm):
        # Deleting model 'Genre'
        db.delete_table('radioways_genre')

        # Removing M2M table for field genres on 'Radio'
        db.delete_table('radioways_radio_genres')
    ...
    models = {
        ...
        'radioways.genre': {
            ...
            'name_uk': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'radioways_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'rtype': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        'radioways.radio': {
