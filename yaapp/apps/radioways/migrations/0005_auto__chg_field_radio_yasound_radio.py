...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Radio.yasound_radio'
        db.alter_column('radioways_radio', 'yasound_radio_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['yabase.Radio'], unique=True, null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Radio.yasound_radio'
        db.alter_column('radioways_radio', 'yasound_radio_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['yabase.Radio'], unique=True, null=True))
    ...
    models = {
        ...
        'radioways.radio': {
            ...
            'yasound_radio': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['yabase.Radio']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        'taggit.tag': {
