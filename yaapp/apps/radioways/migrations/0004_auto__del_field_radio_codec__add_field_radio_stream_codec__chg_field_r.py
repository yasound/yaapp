...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Radio.codec'
        db.delete_column('radioways_radio', 'codec')

        # Adding field 'Radio.stream_codec'
        db.add_column('radioways_radio', 'stream_codec',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Radio.stream_response_time'
        db.alter_column('radioways_radio', 'stream_response_time', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'Genre.rtype'
        db.delete_column('radioways_genre', 'rtype')

        # Adding field 'Genre.gtype'
        db.add_column('radioways_genre', 'gtype',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Radio.codec'
        db.add_column('radioways_radio', 'codec',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Radio.stream_codec'
        db.delete_column('radioways_radio', 'stream_codec')


        # Changing field 'Radio.stream_response_time'
        db.alter_column('radioways_radio', 'stream_response_time', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Genre.rtype'
        db.add_column('radioways_genre', 'rtype',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Genre.gtype'
        db.delete_column('radioways_genre', 'gtype')
    ...
    models = {
        ...
        'radioways.genre': {
            ...
            'gtype': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name_de': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'name_es': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'name_fr': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'radioways.radio': {
            ...
            'genres': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['radioways.Genre']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'stream_codec': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'stream_response_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
