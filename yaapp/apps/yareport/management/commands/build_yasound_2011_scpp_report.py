...
from yareport.utils import build_yasound_2011_scpp_report_file
...
class Command(BaseCommand):
    ...
    help = "Build yasound 2011's song report for SCPP"
    args = ''
    ...
    def handle(self, *app_labels, **options):
        ...
        build_yasound_2011_scpp_report_file(out_dir, radio=radio)
