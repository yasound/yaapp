...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.facebook_needed'
        db.add_column('yapremium_gift', 'facebook_needed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Gift.twitter_needed'
        db.add_column('yapremium_gift', 'twitter_needed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Gift.radio_needed'
        db.add_column('yapremium_gift', 'radio_needed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.facebook_needed'
        db.delete_column('yapremium_gift', 'facebook_needed')

        # Deleting field 'Gift.twitter_needed'
        db.delete_column('yapremium_gift', 'twitter_needed')

        # Deleting field 'Gift.radio_needed'
        db.delete_column('yapremium_gift', 'radio_needed')
