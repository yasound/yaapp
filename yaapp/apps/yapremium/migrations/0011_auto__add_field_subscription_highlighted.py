...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.highlighted'
        db.add_column('yapremium_subscription', 'highlighted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.highlighted'
        db.delete_column('yapremium_subscription', 'highlighted')
