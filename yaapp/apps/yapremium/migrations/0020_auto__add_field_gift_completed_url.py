...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.completed_url'
        db.add_column('yapremium_gift', 'completed_url',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.completed_url'
        db.delete_column('yapremium_gift', 'completed_url')
