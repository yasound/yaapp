...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.duration_unit'
        db.add_column('yapremium_subscription', 'duration_unit',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.duration_unit'
        db.delete_column('yapremium_subscription', 'duration_unit')
