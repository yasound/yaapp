...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.sku'
        db.add_column('yapremium_gift', 'sku',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Gift.authentication_needed'
        db.add_column('yapremium_gift', 'authentication_needed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.sku'
        db.delete_column('yapremium_gift', 'sku')

        # Deleting field 'Gift.authentication_needed'
        db.delete_column('yapremium_gift', 'authentication_needed')
