...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('yapremium_promocode', (
        ...
        db.send_create_signal('yapremium', ['Promocode'])

        # Adding model 'UserPromocode'
        db.create_table('yapremium_userpromocode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('promocode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yapremium.Promocode'])),
            ('usage_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('yapremium', ['UserPromocode'])


    def backwards(self, orm):
        # Deleting model 'Promocode'
        db.delete_table('yapremium_promocode')

        # Deleting model 'UserPromocode'
        db.delete_table('yapremium_userpromocode')
