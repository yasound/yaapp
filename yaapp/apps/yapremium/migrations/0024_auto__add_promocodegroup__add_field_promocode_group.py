...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PromocodeGroup'
        db.create_table('yapremium_promocodegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('yapremium', ['PromocodeGroup'])

        # Adding field 'Promocode.group'
        db.add_column('yapremium_promocode', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yapremium.PromocodeGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PromocodeGroup'
        db.delete_table('yapremium_promocodegroup')

        # Deleting field 'Promocode.group'
        db.delete_column('yapremium_promocode', 'group_id')
