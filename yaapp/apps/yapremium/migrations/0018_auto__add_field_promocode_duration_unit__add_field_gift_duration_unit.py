...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promocode.duration_unit'
        db.add_column('yapremium_promocode', 'duration_unit',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Gift.duration_unit'
        db.add_column('yapremium_gift', 'duration_unit',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promocode.duration_unit'
        db.delete_column('yapremium_promocode', 'duration_unit')

        # Deleting field 'Gift.duration_unit'
        db.delete_column('yapremium_gift', 'duration_unit')
