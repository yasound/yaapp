...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gift.action_url_web'
        db.add_column('yapremium_gift', 'action_url_web',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Gift.action_url_web'
        db.delete_column('yapremium_gift', 'action_url_web')
