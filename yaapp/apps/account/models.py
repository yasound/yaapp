...
class UserProfile(models.Model):
    ...
    twitter_token = models.CharField(max_length=150, blank=True)
    twitter_token_secret = models.CharField(max_length=150, blank=True)
    facebook_token = models.CharField(max_length=150, blank=True)
