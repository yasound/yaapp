...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.permissions'
        db.add_column('account_userprofile', 'permissions',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.permissions'
        db.delete_column('account_userprofile', 'permissions')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'permissions': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
