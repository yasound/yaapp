...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.last_authentication_date'
        db.add_column('account_userprofile', 'last_authentication_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.last_authentication_date'
        db.delete_column('account_userprofile', 'last_authentication_date')
