...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('account_userprofile', 'privacy')

        # Deleting field 'UserProfile.age'
        db.delete_column('account_userprofile', 'age')

        # Deleting field 'UserProfile.gender'
        db.delete_column('account_userprofile', 'gender')
