...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Device', fields ['user']
        db.delete_unique('account_device', ['user_id'])

        # Changing field 'Device.user'
        db.alter_column('account_device', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Device.user'
        db.alter_column('account_device', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'Device', fields ['user']
        db.create_unique('account_device', ['user_id'])


    models = {
        'account.device': {
            'Meta': {'unique_together': "(('user', 'uuid'),)", 'object_name': 'Device'},
