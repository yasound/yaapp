...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.friends_count'
        db.add_column('account_userprofile', 'friends_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.followers_count'
        db.add_column('account_userprofile', 'followers_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.friends_count'
        db.delete_column('account_userprofile', 'friends_count')

        # Deleting field 'UserProfile.followers_count'
        db.delete_column('account_userprofile', 'followers_count')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'permissions': ('django.db.models.fields.BigIntegerField', [], {'default': '1'}),
            'picture': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'privacy': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
