...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Device.application_identifier'
        db.add_column('account_device', 'application_identifier', self.gf('django.db.models.fields.CharField')(default='com.yasound.yasound', max_length=127), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Device.application_identifier'
        db.delete_column('account_device', 'application_identifier')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'notifications_preferences': ('django.db.models.fields.BigIntegerField', [], {'default': '250'}),
