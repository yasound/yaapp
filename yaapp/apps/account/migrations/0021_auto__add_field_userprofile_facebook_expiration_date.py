...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.facebook_expiration_date'
        db.add_column('account_userprofile', 'facebook_expiration_date', self.gf('django.db.models.fields.CharField')(default='', max_length=35, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.facebook_expiration_date'
        db.delete_column('account_userprofile', 'facebook_expiration_date')
