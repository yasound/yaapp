...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.account_type'
        db.add_column('account_userprofile', 'account_type', self.gf('django.db.models.fields.CharField')(default='yasound', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.account_type'
        db.delete_column('account_userprofile', 'account_type')
