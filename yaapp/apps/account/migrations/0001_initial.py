...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_userprofile', (
            ...
            ('twitter_uid', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('facebook_uid', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
