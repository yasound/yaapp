...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.x_coord'
        db.add_column('account_userprofile', 'x_coord', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'UserProfile.y_coord'
        db.add_column('account_userprofile', 'y_coord', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'UserProfile.z_coord'
        db.add_column('account_userprofile', 'z_coord', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.x_coord'
        db.delete_column('account_userprofile', 'x_coord')

        # Deleting field 'UserProfile.y_coord'
        db.delete_column('account_userprofile', 'y_coord')

        # Deleting field 'UserProfile.z_coord'
        db.delete_column('account_userprofile', 'z_coord')


    models = {
        'account.device': {
            'Meta': {'unique_together': "(('user', 'ios_token'),)", 'object_name': 'Device'},
            'application_identifier': ('django.db.models.fields.CharField', [], {'default': "'com.yasound.yasound'", 'max_length': '127'}),
        ...
        'account.userprofile': {
            ...
            'facebook_expiration_date': ('django.db.models.fields.CharField', [], {'max_length': '35', 'blank': 'True'}),
            ...
            'notifications_preferences': ('django.db.models.fields.BigIntegerField', [], {'default': '4090'}),
            ...
            'x_coord': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'y_coord': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'yasound_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            'z_coord': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
        'auth.group': {
