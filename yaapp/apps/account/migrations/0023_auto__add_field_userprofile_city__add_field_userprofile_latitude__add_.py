...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_userprofile', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'UserProfile.latitude'
        db.add_column('account_userprofile', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)

        # Adding field 'UserProfile.longitude'
        db.add_column('account_userprofile', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('account_userprofile', 'latitude')

        # Deleting field 'UserProfile.longitude'
        db.delete_column('account_userprofile', 'longitude')
