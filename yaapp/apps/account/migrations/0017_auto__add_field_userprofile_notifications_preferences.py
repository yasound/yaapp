...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.notifications_preferences'
        db.add_column('account_userprofile', 'notifications_preferences', self.gf('django.db.models.fields.BigIntegerField')(default=254), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.notifications_preferences'
        db.delete_column('account_userprofile', 'notifications_preferences')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'notifications_preferences': ('django.db.models.fields.BigIntegerField', [], {'default': '254'}),
