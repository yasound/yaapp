...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailConfirmation.retries'
        db.add_column('emailconfirmation_emailconfirmation', 'retries', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EmailConfirmation.retries'
        db.delete_column('emailconfirmation_emailconfirmation', 'retries')
