...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RadioListeningStat'
        db.create_table('stats_radiolisteningstat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('radio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabase.Radio'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('overall_listening_time', self.gf('django.db.models.fields.FloatField')()),
            ('audience_peak', self.gf('django.db.models.fields.IntegerField')()),
            ('favorites', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('stats', ['RadioListeningStat'])


    def backwards(self, orm):
        
        # Deleting model 'RadioListeningStat'
        db.delete_table('stats_radiolisteningstat')
