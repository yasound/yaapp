...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RadioListeningStat.audience'
        db.delete_column('stats_radiolisteningstat', 'audience')

        # Adding field 'RadioListeningStat.audience_peak'
        db.add_column('stats_radiolisteningstat', 'audience_peak', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'RadioListeningStat.connections'
        db.add_column('stats_radiolisteningstat', 'connections', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RadioListeningStat.audience'
        db.add_column('stats_radiolisteningstat', 'audience', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'RadioListeningStat.audience_peak'
        db.delete_column('stats_radiolisteningstat', 'audience_peak')

        # Deleting field 'RadioListeningStat.connections'
        db.delete_column('stats_radiolisteningstat', 'connections')
    ...
    models = {
        ...
        'stats.radiolisteningstat': {
            'Meta': {'object_name': 'RadioListeningStat'},
            'audience_peak': ('django.db.models.fields.IntegerField', [], {}),
            'connections': ('django.db.models.fields.IntegerField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dislikes': ('django.db.models.fields.IntegerField', [], {}),
            'favorites': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('django.db.models.fields.IntegerField', [], {}),
            'overall_listening_time': ('django.db.models.fields.FloatField', [], {}),
