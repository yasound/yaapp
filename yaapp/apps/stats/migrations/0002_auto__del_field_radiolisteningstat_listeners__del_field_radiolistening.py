...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RadioListeningStat.listeners'
        db.delete_column('stats_radiolisteningstat', 'listeners')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'RadioListeningStat.listeners'
        db.add_column('stats_radiolisteningstat', 'listeners', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
