...
urlpatterns = patterns('yaweb.views',
    ...
    url(r'^concours/la-love-mix-tape/$', 'valentine_2013', name='valentine_2013'),
    url(r'^concours/la-love-mix-tape/iphone/$', 'valentine_2013_iphone', name='valentine_2013_iphone'),
