...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.current_connections'
        db.add_column('yabase_radio', 'current_connections', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Radio.current_connections'
        db.delete_column('yabase_radio', 'current_connections')
