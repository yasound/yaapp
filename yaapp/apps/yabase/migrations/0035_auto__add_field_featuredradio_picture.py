...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedRadio.picture'
        db.add_column('yabase_featuredradio', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeaturedRadio.picture'
        db.delete_column('yabase_featuredradio', 'picture')
