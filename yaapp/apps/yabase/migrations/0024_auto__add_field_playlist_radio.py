...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Playlist.radio'
        db.add_column('yabase_playlist', 'radio', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='playlists', null=True, to=orm['yabase.Radio']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Playlist.radio'
        db.delete_column('yabase_playlist', 'radio_id')
