...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Radio.uuid'
        db.alter_column('yabase_radio', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=48))


    def backwards(self, orm):
        
        # Changing field 'Radio.uuid'
        db.alter_column('yabase_radio', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=32))
