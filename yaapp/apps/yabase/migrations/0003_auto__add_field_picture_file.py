...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('yabase_picture', 'file', self.gf('django.db.models.fields.files.ImageField')(default=datetime.date(2011, 12, 7), max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Picture.file'
        db.delete_column('yabase_picture', 'file')
