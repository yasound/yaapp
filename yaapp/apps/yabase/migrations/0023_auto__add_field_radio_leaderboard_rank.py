...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.leaderboard_rank'
        db.add_column('yabase_radio', 'leaderboard_rank', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Radio.leaderboard_rank'
        db.delete_column('yabase_radio', 'leaderboard_rank')
