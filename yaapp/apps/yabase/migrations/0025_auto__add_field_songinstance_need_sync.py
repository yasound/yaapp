...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongInstance.need_sync'
        db.add_column('yabase_songinstance', 'need_sync', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongInstance.need_sync'
        db.delete_column('yabase_songinstance', 'need_sync')
