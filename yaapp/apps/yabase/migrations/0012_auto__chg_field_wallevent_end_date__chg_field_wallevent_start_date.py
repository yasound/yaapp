...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WallEvent.end_date'
        db.alter_column('yabase_wallevent', 'end_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'WallEvent.start_date'
        db.alter_column('yabase_wallevent', 'start_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'WallEvent.end_date'
        db.alter_column('yabase_wallevent', 'end_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'WallEvent.start_date'
        db.alter_column('yabase_wallevent', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
