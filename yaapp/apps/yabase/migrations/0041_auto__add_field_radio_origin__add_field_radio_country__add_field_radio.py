...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Radio.origin'
        db.add_column('yabase_radio', 'origin',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Radio.country'
        db.add_column('yabase_radio', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yageoperm.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Radio.city'
        db.add_column('yabase_radio', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Radio.latitude'
        db.add_column('yabase_radio', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Radio.longitude'
        db.add_column('yabase_radio', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Radio.origin'
        db.delete_column('yabase_radio', 'origin')

        # Deleting field 'Radio.country'
        db.delete_column('yabase_radio', 'country_id')

        # Deleting field 'Radio.city'
        db.delete_column('yabase_radio', 'city')

        # Deleting field 'Radio.latitude'
        db.delete_column('yabase_radio', 'latitude')

        # Deleting field 'Radio.longitude'
        db.delete_column('yabase_radio', 'longitude')
