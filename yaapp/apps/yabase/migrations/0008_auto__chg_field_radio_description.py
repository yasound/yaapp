...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Radio.description'
        db.alter_column('yabase_radio', 'description', self.gf('django.db.models.fields.TextField')(default=''))


    def backwards(self, orm):
        
        # Changing field 'Radio.description'
        db.alter_column('yabase_radio', 'description', self.gf('django.db.models.fields.TextField')(null=True))
