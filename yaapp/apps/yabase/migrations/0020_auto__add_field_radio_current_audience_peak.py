...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.current_audience_peak'
        db.add_column('yabase_radio', 'current_audience_peak', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Radio.current_audience_peak'
        db.delete_column('yabase_radio', 'current_audience_peak')
