...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongMetadata.yasound_song_id'
        db.add_column('yabase_songmetadata', 'yasound_song_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongMetadata.yasound_song_id'
        db.delete_column('yabase_songmetadata', 'yasound_song_id')
