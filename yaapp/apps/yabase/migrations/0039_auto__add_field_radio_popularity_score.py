...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Radio.popularity_score'
        db.add_column('yabase_radio', 'popularity_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Radio.popularity_score'
        db.delete_column('yabase_radio', 'popularity_score')
