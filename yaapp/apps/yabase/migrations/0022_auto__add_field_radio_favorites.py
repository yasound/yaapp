...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.favorites'
        db.add_column('yabase_radio', 'favorites', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Radio.favorites'
        db.delete_column('yabase_radio', 'favorites')
