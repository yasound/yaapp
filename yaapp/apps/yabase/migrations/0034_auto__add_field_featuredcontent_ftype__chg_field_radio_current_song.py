...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedContent.ftype'
        db.add_column('yabase_featuredcontent', 'ftype',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=1),
                      keep_default=False)


        # Changing field 'Radio.current_song'
        db.alter_column('yabase_radio', 'current_song_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['yabase.SongInstance']))
    def backwards(self, orm):
        # Deleting field 'FeaturedContent.ftype'
        db.delete_column('yabase_featuredcontent', 'ftype')
