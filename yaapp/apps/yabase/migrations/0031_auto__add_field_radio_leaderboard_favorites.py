...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.leaderboard_favorites'
        db.add_column('yabase_radio', 'leaderboard_favorites', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Radio.leaderboard_favorites'
        db.delete_column('yabase_radio', 'leaderboard_favorites')
