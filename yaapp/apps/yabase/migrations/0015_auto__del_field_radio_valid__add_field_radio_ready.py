...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Radio.valid'
        db.delete_column('yabase_radio', 'valid')

        # Adding field 'Radio.ready'
        db.add_column('yabase_radio', 'ready', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Radio.valid'
        db.add_column('yabase_radio', 'valid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Radio.ready'
        db.delete_column('yabase_radio', 'ready')
