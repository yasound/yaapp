...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeaturedRadio'
        db.create_table('yabase_featuredradio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('featured_content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabase.FeaturedContent'])),
            ('radio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabase.Radio'])),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('yabase', ['FeaturedRadio'])

        # Adding unique constraint on 'FeaturedRadio', fields ['featured_content', 'radio']
        db.create_unique('yabase_featuredradio', ['featured_content_id', 'radio_id'])

        # Adding model 'FeaturedContent'
        db.create_table('yabase_featuredcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('yabase', ['FeaturedContent'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FeaturedRadio', fields ['featured_content', 'radio']
        db.delete_unique('yabase_featuredradio', ['featured_content_id', 'radio_id'])

        # Deleting model 'FeaturedRadio'
        db.delete_table('yabase_featuredradio')

        # Deleting model 'FeaturedContent'
        db.delete_table('yabase_featuredcontent')
