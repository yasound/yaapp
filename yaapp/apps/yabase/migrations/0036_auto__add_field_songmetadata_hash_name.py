...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SongMetadata.hash_name'
        db.add_column('yabase_songmetadata', 'hash_name',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SongMetadata.hash_name'
        db.delete_column('yabase_songmetadata', 'hash_name')
