...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'YasoundDoubleMetaphone.secondary'
        db.delete_column('yasound_doublemetaphone', 'secondary')

        # Deleting field 'YasoundDoubleMetaphone.primary'
        db.delete_column('yasound_doublemetaphone', 'primary')

        # Adding field 'YasoundDoubleMetaphone.value'
        db.add_column(u'yasound_doublemetaphone', 'value', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'YasoundDoubleMetaphone.secondary'
        db.add_column('yasound_doublemetaphone', 'secondary', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'YasoundDoubleMetaphone.primary'
        db.add_column('yasound_doublemetaphone', 'primary', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'YasoundDoubleMetaphone.value'
        db.delete_column(u'yasound_doublemetaphone', 'value')
