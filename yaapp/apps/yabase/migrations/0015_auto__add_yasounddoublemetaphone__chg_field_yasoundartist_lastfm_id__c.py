...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('yasound_doublemetaphone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('primary', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('secondary', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('yasound_doublemetaphone')
    ...
    models = {
        ...
        'yabase.yasounddoublemetaphone': {
            'Meta': {'object_name': 'YasoundDoubleMetaphone'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'secondary': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        'yabase.yasoundgenre': {
