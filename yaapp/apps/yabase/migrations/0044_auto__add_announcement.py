...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('yabase_announcement', (
            ...
            ('body_en', self.gf('django.db.models.fields.TextField')(max_length=255, blank=True)),
            ('body_fr', self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('yabase', ['Announcement'])


    def backwards(self, orm):
        # Deleting model 'Announcement'
        db.delete_table('yabase_announcement')
    ...
    models = {
        ...
        'yabase.announcement': {
            ...
            'body_en': ('django.db.models.fields.TextField', [], {'max_length': '255', 'blank': 'True'}),
            'body_fr': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
