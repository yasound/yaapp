...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WallEvent.end_date'
        db.delete_column('yabase_wallevent', 'end_date')

        # Deleting field 'WallEvent.old_id'
        db.delete_column('yabase_wallevent', 'old_id')

        # Adding field 'WallEvent.song_name'
        db.add_column('yabase_wallevent', 'song_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'WallEvent.song_album'
        db.add_column('yabase_wallevent', 'song_album', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'WallEvent.song_artist'
        db.add_column('yabase_wallevent', 'song_artist', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'WallEvent.song_cover_filename'
        db.add_column('yabase_wallevent', 'song_cover_filename', self.gf('django.db.models.fields.CharField')(default='', max_length=45, blank=True), keep_default=False)

        # Adding field 'WallEvent.user_name'
        db.add_column('yabase_wallevent', 'user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True), keep_default=False)

        # Adding field 'WallEvent.user_picture'
        db.add_column('yabase_wallevent', 'user_picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Radio.current_song'
        db.add_column('yabase_radio', 'current_song', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='current_song_radio', null=True, to=orm['yabase.SongInstance']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'WallEvent.end_date'
        db.add_column('yabase_wallevent', 'end_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=1, blank=True), keep_default=False)

        # Adding field 'WallEvent.old_id'
        db.add_column('yabase_wallevent', 'old_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'WallEvent.song_name'
        db.delete_column('yabase_wallevent', 'song_name')

        # Deleting field 'WallEvent.song_album'
        db.delete_column('yabase_wallevent', 'song_album')

        # Deleting field 'WallEvent.song_artist'
        db.delete_column('yabase_wallevent', 'song_artist')

        # Deleting field 'WallEvent.song_cover_filename'
        db.delete_column('yabase_wallevent', 'song_cover_filename')

        # Deleting field 'WallEvent.user_name'
        db.delete_column('yabase_wallevent', 'user_name')

        # Deleting field 'WallEvent.user_picture'
        db.delete_column('yabase_wallevent', 'user_picture')

        # Deleting field 'Radio.current_song'
        db.delete_column('yabase_radio', 'current_song_id')
