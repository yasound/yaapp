...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.computing_next_songs'
        db.add_column('yabase_radio', 'computing_next_songs', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Radio.computing_next_songs'
        db.delete_column('yabase_radio', 'computing_next_songs')
