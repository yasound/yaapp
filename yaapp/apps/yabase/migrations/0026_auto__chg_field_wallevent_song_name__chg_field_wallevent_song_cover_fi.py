...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WallEvent.song_name'
        db.alter_column('yabase_wallevent', 'song_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WallEvent.song_cover_filename'
        db.alter_column('yabase_wallevent', 'song_cover_filename', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))

        # Changing field 'WallEvent.song_album'
        db.alter_column('yabase_wallevent', 'song_album', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'WallEvent.user_name'
        db.alter_column('yabase_wallevent', 'user_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'WallEvent.song_artist'
        db.alter_column('yabase_wallevent', 'song_artist', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'WallEvent.song_name'
        db.alter_column('yabase_wallevent', 'song_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'WallEvent.song_cover_filename'
        db.alter_column('yabase_wallevent', 'song_cover_filename', self.gf('django.db.models.fields.CharField')(default='', max_length=45))

        # Changing field 'WallEvent.song_album'
        db.alter_column('yabase_wallevent', 'song_album', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'WallEvent.user_name'
        db.alter_column('yabase_wallevent', 'user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60))

        # Changing field 'WallEvent.song_artist'
        db.alter_column('yabase_wallevent', 'song_artist', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
