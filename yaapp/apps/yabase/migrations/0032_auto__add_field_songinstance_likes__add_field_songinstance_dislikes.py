...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongInstance.likes'
        db.add_column('yabase_songinstance', 'likes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SongInstance.dislikes'
        db.add_column('yabase_songinstance', 'dislikes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongInstance.likes'
        db.delete_column('yabase_songinstance', 'likes')

        # Deleting field 'SongInstance.dislikes'
        db.delete_column('yabase_songinstance', 'dislikes')
