...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ApnsCertificate'
        db.create_table('yabase_apnscertificate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application_id', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('sandbox', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('certificate_file', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('yabase', ['ApnsCertificate'])


    def backwards(self, orm):
        
        # Deleting model 'ApnsCertificate'
        db.delete_table('yabase_apnscertificate')
