...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Radio.new_wall_messages_count'
        db.add_column('yabase_radio', 'new_wall_messages_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Radio.current_song'
        db.alter_column('yabase_radio', 'current_song_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['yabase.SongInstance']))


    def backwards(self, orm):
        
        # Deleting field 'Radio.new_wall_messages_count'
        db.delete_column('yabase_radio', 'new_wall_messages_count')

        # Changing field 'Radio.current_song'
        db.alter_column('yabase_radio', 'current_song_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['yabase.SongInstance'], on_delete=models.SET_NULL))
