...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongInstance.playlist'
        db.add_column('yabase_songinstance', 'playlist', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.date(2011, 12, 7), to=orm['yabase.Playlist']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SongInstance.playlist'
        db.delete_column('yabase_songinstance', 'playlist_id')
