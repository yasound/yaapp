...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SongMetadata.name'
        db.alter_column('yabase_songmetadata', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SongMetadata.artist_name'
        db.alter_column('yabase_songmetadata', 'artist_name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SongMetadata.album_name'
        db.alter_column('yabase_songmetadata', 'album_name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Playlist.name'
        db.alter_column('yabase_playlist', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Playlist.source'
        db.alter_column('yabase_playlist', 'source', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Radio.name'
        db.alter_column('yabase_radio', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Radio.theme'
        db.alter_column('yabase_radio', 'theme', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'Radio.genre'
        db.alter_column('yabase_radio', 'genre', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        'yabase.radio': {
            ...
            'genre': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'yabase.songmetadata': {
            ...
            'album_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'artist_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
