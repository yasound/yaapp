...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongInstance.order'
        db.add_column('yabase_songinstance', 'order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'SongMetadata.duration'
        db.alter_column('yabase_songmetadata', 'duration', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'SongInstance.order'
        db.delete_column('yabase_songinstance', 'order')

        # Changing field 'SongMetadata.duration'
        db.alter_column('yabase_songmetadata', 'duration', self.gf('django.db.models.fields.FloatField')(default=datetime.date(2011, 12, 16)))
