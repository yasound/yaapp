...
urlpatterns = patterns('yabase.views',
    ...
    url(r'^app/help/$', WebAppView.as_view(), {'page': 'help'}, name='webapp_default_help'),
    url(r'^app/press/$', WebAppView.as_view(), {'page': 'press'}, name='webapp_default_press'),
    ...
    url(r'^(?P<app_name>\w+)/help/$', WebAppView.as_view(), {'page': 'help'}, name='webapp_help'),
    url(r'^(?P<app_name>\w+)/tutorial/$', WebAppView.as_view(), {'page': 'tutorial'}, name='webapp_tutorial'),
    url(r'^(?P<app_name>\w+)/press/$', WebAppView.as_view(), {'page': 'press'}, name='webapp_press'),
