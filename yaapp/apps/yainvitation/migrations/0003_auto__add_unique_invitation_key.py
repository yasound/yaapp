...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Invitation', fields ['key']
        db.create_unique('yainvitation_invitation', ['key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Invitation', fields ['key']
        db.delete_unique('yainvitation_invitation', ['key'])
