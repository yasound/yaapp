...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invitation.radio'
        db.alter_column('yainvitation_invitation', 'radio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['yabase.Radio'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Invitation.radio'
        db.alter_column('yainvitation_invitation', 'radio_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['yabase.Radio']))
