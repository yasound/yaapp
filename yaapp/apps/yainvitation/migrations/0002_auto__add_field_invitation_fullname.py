...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.fullname'
        db.add_column('yainvitation_invitation', 'fullname', self.gf('django.db.models.fields.CharField')(default='name', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invitation.fullname'
        db.delete_column('yainvitation_invitation', 'fullname')
