...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.subject'
        db.add_column('yainvitation_invitation', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Invitation.subject'
        db.delete_column('yainvitation_invitation', 'subject')
