...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.subjet'
        db.add_column('yainvitation_invitation', 'subjet', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Invitation.message'
        db.add_column('yainvitation_invitation', 'message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Invitation.sent'
        db.alter_column('yainvitation_invitation', 'sent', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Invitation.subjet'
        db.delete_column('yainvitation_invitation', 'subjet')

        # Deleting field 'Invitation.message'
        db.delete_column('yainvitation_invitation', 'message')

        # Changing field 'Invitation.sent'
        db.alter_column('yainvitation_invitation', 'sent', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 3, 8)))
    ...
    models = {
        ...
        'yainvitation.invitation': {
            ...
            'subjet': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
