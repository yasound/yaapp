...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Invitation.key'
        db.delete_column('yainvitation_invitation', 'key')

        # Adding field 'Invitation.invitation_key'
        db.add_column('yainvitation_invitation', 'invitation_key', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Invitation.key'
        db.add_column('yainvitation_invitation', 'key', self.gf('django.db.models.fields.CharField')(default='', max_length=40, unique=True, blank=True), keep_default=False)

        # Deleting field 'Invitation.invitation_key'
        db.delete_column('yainvitation_invitation', 'invitation_key')
    ...
    models = {
        ...
        'yainvitation.invitation': {
            'Meta': {'object_name': 'Invitation'},
            'email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitation_key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'blank': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'radio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['yabase.Radio']", 'null': 'True', 'blank': 'True'}),
