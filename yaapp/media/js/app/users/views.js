...
Yasound.Views.Users = Backbone.View.extend({
    initialize: function() {
...
Yasound.Views.UsersPage = Backbone.View.extend({
    initialize: function() {
    ...
    render: function() {
        this.reset();
        $(this.el).html(ich.usersPageTemplate());
        
        this.resultsView = new Yasound.Views.Users({
